...
class Aliyun_Log_Client
{
     ...
     * return Aliyun_Log_Models_CreateShipperResponse
     */
    public function createProject(Aliyun_Log_Models_CreateProjectRequest $request)
    {
        $headers = array();
        $params = array();
        $resource = '/';
        ...
        list($resp, $header) = $this->send("POST", null, $body_str, $resource, $params, $headers);
        $requestId = isset ($header ['x-log-requestid']) ? $header ['x-log-requestid'] : '';
        $resp = $this->parseToJson($resp, $requestId);
    ...
    public function createConfig(Aliyun_Log_Models_CreateConfigRequest $request)
    {
        ...
        $project = $request->getConfig()['outputDetail']['projectName'];
        if ($request->getConfig() !== null) {
            // 去掉toArray 方法，不存在
            $body = json_encode($request->getConfig());
        }
//        echo $body;die;
        $headers ['Content-Type'] = 'application/json';
        $resource = '/configs';
    ...
    public function updateConfig(Aliyun_Log_Models_UpdateConfigRequest $request, $project)
    {
        $params = array();
        $headers = array();
        $body = null;
        ...
        $headers ['Content-Type'] = 'application/json';
        $resource = '/configs/' . $request->getConfig()['configName'];

        list($resp, $header) = $this->send("PUT", $project, $body, $resource, $params, $headers);
    ...
    public function createIndex(Aliyun_Log_Models_CreateIndexRequest $request)
    {
        $params = array();
        $headers = array();
        $body = null;
        ...
        $project = $request->getProject() !== null ? $request->getProject() : '';
        $headers ['Content-Type'] = 'application/json';
        $resource = '/logstores/' . $request->getLogstoreName() . '/index';
    ...
    public function updateIndex(Aliyun_Log_Models_UpdateIndexRequest $request)
    {
        $params = array();
        $headers = array();
        $body = null;
    ...
    public function createMachineGroup(Aliyun_Log_Models_CreateMachineGroupRequest $request, $project)
    {
        $params = array();
        $headers = array();
        $body = null;
        if ($request->getMachineGroup() !== null) {
            $body = json_encode($request->getMachineGroup());
        }
        $headers ['Content-Type'] = 'application/json';
    ...
    public function updateMachineGroup(Aliyun_Log_Models_UpdateMachineGroupRequest $request, $project)
    {
        $params = array();
        $headers = array();
        $body = null;
        ...
        if ($request->getMachineGroup() !== null) {
            $body = json_encode($request->getMachineGroup());
            $groupName = ($request->getMachineGroup()['groupName'] !== null) ? $request->getMachineGroup()['groupName'] : '';
        }
    ...
    public function applyConfigToMachineGroup(Aliyun_Log_Models_ApplyConfigToMachineGroupRequest $request, $project)
    {
        $params = array();
        $headers = array();
        ...
        list($resp, $header) = $this->send("PUT", $project, NULL, $resource, $params, $headers);
        return new Aliyun_Log_Models_ApplyConfigToMachineGroupResponse($header);
    }

    public function removeConfigFromMachineGroup(Aliyun_Log_Models_RemoveConfigFromMachineGroupRequest $request, $project)
    {
        $params = array();
        $headers = array();
        $configName = $request->getConfigName();
